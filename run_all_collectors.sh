...
python run_collectors.py device42.main --username $DEVICE42_USERNAME --password $DEVICE42_PASSWD --service_levels Stage Production $*

python run_collectors.py netscalar.main --view lbvserver --username $NETSCALAR_USERNAME --password $NETSCALAR_PASSWD --host $DEVICE42_HOST $*
